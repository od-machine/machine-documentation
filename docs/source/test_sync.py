...
def get_patient_recommendations_edges(patient_id, edge_collection, arangoDB):
    ...
    :param patient_id - string of the patient_id
...
def summary_translate(patients):
    ...
    :param patients - list of dicts with patients attributes
...
def create_recs_dict_to_letters(recommendations_data):
    ...
    :param recommendations_data - {Patient_id1:[{key-value pairs with recommendation1 data},{key-value pairs with recommendation2 data}]},{Patient_id2:[{...}]} 
...
def create_and_merge_edges(patient_id, recs_list, edges_date, edge_collection, existing_edges):
    ...
    :param patient_id - string of the patient_id
    :param recs_list - list of dictionaries with recommendations details of single patient
...
def match_patients_conditions(general_conditions, age_conditions, patients):
    ...
    :param general_conditions - list of patient's general conditions ids
    :param age_conditions - list of patient's age conditions ids
    :param patients - list of patients details
...
def get_recommendations_from_neo4j(conditions_list, cities_list, origins_list, graphDB):
    ...
    :param conditions_list - patient's conditions ids list.
    :param cities_list - patient's cities ids list.
...
def parse_recommendations(patient_id, recommendations_data):
    ...
    :param patient_id - the current patient id
    :param recommendations_data - list of dictionaries with recommendations details
...
def get_patients_recommendations_data(patient_conditions_and_cities, graphDB):
    ...
    :param patient_conditions_and_cities - dictionary of the patients, their conditions ids list and their cities ids list.
...
def update_arango(recommendations_to_arango, edges_to_arango, arangoDB):
    ...
    :param recommendations_to_arango - list of recs dictionaries to add Recommendations collection
